...
(1,'Una de las mejores experiencias en un juego y con un profundo mensaje',1,1),
(2,'¿Quién pensaría que los franceses podrían hacer grandes juegos?',2,2),
(3,'Un juegazo de puzles y exploración, todo está conectado aunque pueda no parecerlo.',3,3),
(4,'Un juego de gestión en un mundo post apocalíptico denso y complicado.',4,4),
(5,'Una carta de amor a juegos como Half Life, Portal y antiguas joyas de Valve mezclado con los SCPs y sistemas de Quality of Life actuales.',5,5);
...
-- Dump completed on 2025-10-08 10:13:13
